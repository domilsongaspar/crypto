...
<body>
    <div class="body">
        <div class="header">
            ...
            <div class="menu">
                <div class="icons">
                    <i class="fa fa-cog fa-lg c-pointer" title="Definições" id="settings"></i>
                    <i class="fa fa-plus fa-lg c-pointer" title="Nova criptografia" id="newCryptography"></i>
                    <a href="http://www.crypto.com/pt/accounts/logout.php" title="Terminar Sessão">
    ...
    <div class="maskMenu none animated" id="idContainer">
        ...
        <div class="field">
            <label for="name" class="bold">Meu ID</label>
    ...
    <div class="maskMenu none animated" id="newCryptoContainer">
        <i class="fa fa-times closeIcon"></i>
        <div class="field">
            <label for="name">Nome da criptografia</label>
            <input type="text" id="name" placeholder="Coloque aqui!">
            <button type="button" class="finish" id="finish">Concluido</button>
        </div>        
    </div>
    ...
    <div class="maskMenu none animated" id="editCryptoContainer">
        ...
        <div class="field">
            <button type="button" class="finish">Concluido</button>
        </div>
